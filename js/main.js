        ...
        if (!isMobile.any) {
            ...
            $(window).scroll(function() {
                ...
                if (fromTop > offset_filtros) {
                    ...
                    $("#fondo-fixed").addClass("fixed").css({
                        top: 0
                    });
                } else {
                    $("#mainmenu").removeClass("fixed").removeAttr("style");
                    $("#fondo-fixed").removeClass("fixed").removeAttr("style");
...
$(".cont-beneficio .circulo-mas").click(function() {
  // Toggle agregar y quitar clase
  $(this).prev('p').toggle()
  $(this).toggleClass('circulo-menos');
});
...
window.onload = function() {
    ...
    $(".loader").remove();
    setTimeout(function(){
      $('#velbed .logo-velbed').addClass('opacidad');
    },1000);
};
